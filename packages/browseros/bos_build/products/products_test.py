...
EXPECTED_BROWSEROS = ProductDescriptor(
    ...
    dev_display_name="Browser Dev",
    company_full_name="Jawaid Gadiwala",
    company_short_name="Jawaid Gadiwala",
    installer_full_name="Browser Installer",
    dev_installer_full_name="Browser Dev Installer",
    app_base_name="Browser",
    artifact_prefix="Browser",
