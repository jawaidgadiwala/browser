...
describe('ENV_REGISTRY', () => {
  test('contains the root env consolidation key census in order', () => {
    expect(ENV_REGISTRY.map((spec) => spec.key)).toEqual([
      ...
      'BROWSEROS_CLAW_EMBEDDED',
      'BROWSERCLAW_DIR',
      'CLAW_POSTHOG_KEY',
      'CLAW_POSTHOG_HOST',
      'VITE_CLAW_POSTHOG_KEY',
      'VITE_CLAW_POSTHOG_HOST',
      // Daily-driver launcher overrides (tools/personal).
      'BROWSEROS_PERSONAL_PROFILE',
      'BROWSEROS_PERSONAL_LOG_DIR',
      'BROWSEROS_PERSONAL_BINARY',
      'BROWSEROS_PERSONAL_STATE_DIR',
      'BROWSEROS_PERSONAL_CLAW_STATE_DIR',
      'BROWSEROS_PERSONAL_CDP_PORT',
      'BROWSEROS_PERSONAL_SERVER_PORT',
      'BROWSEROS_PERSONAL_EXTENSION_PORT',
      'BROWSEROS_PERSONAL_CLAW_PORT',
