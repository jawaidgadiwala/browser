...
const NOT_CONNECTED: &str = "browser session not connected; the agent browser is not running or paired. Tell the user to start Browser and check the cockpit connection status; do not fall back to another browser tool.";
