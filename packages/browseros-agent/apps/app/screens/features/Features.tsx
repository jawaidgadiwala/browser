...
const features: Feature[] = [
  ...
  },
  {
    ...
    detailedDescription: `${PRODUCT_NAME} includes a built-in MCP server that lets AI coding agents control your browser. Claude Code can open tabs, click elements, fill forms, take screenshots, and read page content—all through natural language commands. Unlike Chrome DevTools MCP which requires debug profiles and separate servers, ${PRODUCT_NAME} works out of the box. Just copy the URL from settings and connect.`,
    highlights: [
          ...
          <div className="space-y-8 text-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                >
                  Watch our launch video to understand the vision of{' '}
                  {PRODUCT_NAME}
                  and key features!
                </p>
              </div>
